...
def upgrade():
    ...
    op.execute("""
        CREATE TABLE contracts (
            ...
            INDEX (ultimate_completion_date),
            INDEX (last_date_to_order),
            INDEX (obligated_amount),
            INDEX (base_and_all_options_value),
            INDEX (total_obligated_amount),
            INDEX (total_base_and_all_options_value),
            INDEX (contracting_office_agency_id),
            INDEX (contracting_office_id),
            INDEX (funding_requesting_agency_id),
            INDEX (funding_requesting_office_id),
            INDEX (contract_action_type_description),
            INDEX (type_of_contract_pricing_description),
            INDEX (multi_year_contract),
            INDEX (referenced_idv_multiple_or_single),
            INDEX (referenced_idv_type),
            INDEX (labor_standards),
            INDEX (psc_code),
            INDEX (psc_type),
            INDEX (naics_code),
            INDEX (country_of_origin),
            INDEX (vendor_name),
            INDEX (is_small_business),
            INDEX (is_veteran_owned_business),
            INDEX (is_women_owned_business),
            INDEX (is_very_small_business),
            INDEX (is_women_owned_small_business),
            INDEX (is_economically_disadvantaged_women_owned_small_business),
            INDEX (is_partnership_or_limited_liability_partnership),
            INDEX (receives_contracts_and_grants),
            INDEX (is_for_profit_organization),
            INDEX (vendor_state_of_incorporation),
            INDEX (vendor_country_of_incorporation),
            INDEX (vendor_location_city),
            INDEX (vendor_location_state),
            INDEX (vendor_location_zipcode),
            INDEX (vendor_location_country),
            INDEX (vendor_uei),
            INDEX (vendor_ultimate_parent_uei),
            INDEX (vendor_cage_code),
            INDEX (vendor_registration_date),
            INDEX (vendor_renewal_date),
            INDEX (vendor_size),
            INDEX (place_of_performance_state),
            INDEX (place_of_performance_country),
            INDEX (place_of_performance_zip),
            INDEX (competition_extent_competed),
            INDEX (competition_solicitation_procedures),
            INDEX (competition_reason_not_competed),
            INDEX (competition_number_of_offers_received),
            INDEX (competition_idv_number_of_offers_received),
            INDEX (competition_fed_biz_opps),
            INDEX (award_transaction_information_status),
            INDEX (file_path)
        )
